	...
	public void filterCheck(int n) throws InterruptedException{
		...
		try{
			...
			if(text.contains("所有异常商品")){
				Assert.assertTrue("'所有'筛选错误",status.equals("A档异常商品") || status.equals("B档异常商品") || status.equals("C档异常商品") || status.equals("供货价为0商品") || status.equals("负毛利商品") || status.equals("供货价异常") || status.equals("销售价异常") || status.equals("促销价异常") || nullText.equals("暂无数据"));
			}else{
