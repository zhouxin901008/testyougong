...
public class ItemExceptionPage {
	...
	public void filterCheck(int n) throws InterruptedException{
		...
		try{
			String status = driver.findElement(By.xpath("//html/body/div[1]/div[2]/div/div/div[4]/ul/li[1]/table/tbody/tr[1]/td[12]")).getText();
			...
			if(text.contains("所有异常商品")){
				Assert.assertTrue("'所有'筛选错误",status.equals("A档异常商品") || status.equals("B档异常商品") || status.equals("C档异常商品") || status.equals("供货价为0商品") || status.equals("负毛利商品") || nullText.equals("暂无数据"));
			}
			else{
	...
	public void wmstatusCheck(int m) throws InterruptedException{
		...
		try{
			String wmstatus = driver.findElement(By.xpath("//html/body/div[1]/div[2]/div/div/div[4]/ul/li[1]/table/tbody/tr[1]/td[13]")).getText();
			String nullText = driver.findElement(By.xpath("//html/body/div[1]/div[2]/div/div/div[4]/ul/li/table/tbody/tr/td")).getText();
			if(text.contains("所有物美状态")){
				Assert.assertTrue("'所有'筛选错误",wmstatus.equals("正常") || wmstatus.equals("正常(新品试销)") || wmstatus.equals("正常(新品评估)") || wmstatus.equals("异常") || wmstatus.equals("正常(目录团购)") || nullText.equals("暂无数据"));
			}
			else{
